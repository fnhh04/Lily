...
/*
Lily smart contract features:
   3% fee auto added to the locked liquidity pool.
   3% fee auto added directly in BNB to the charity wallet for sea-related non-profit organizations.
   2% fee auto distributed to all holders.
   30% of the Total Supply has been burnt.
   10% of the Total supply has been sent to our locked charity wallet.
*/
contract Fnhh is Context, IERC20, Ownable {
    ...
    string private _name = "Fnhh_London";
    string private _symbol = "FNHH";
    ...
    // restrict the amount of maximum transaction
    ...
    constructor () public {
        ...
        // Uniswap address pointer --> to PancakeSwap
        ...
        //addresses are defined in "Ownable.sol"
    ...
    // 2x liquidity fee is applied on dev wallets accounts for transactions
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            // lockedLiquidity is an address defined in Ownable.sol by the owner of the contract, 
            // once defined address will be fixed and cannot change 
            lockedLiquidity(),
            block.timestamp
        );
    }
